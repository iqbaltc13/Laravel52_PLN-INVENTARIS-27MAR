  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-primary">
        ...
        <form class="form-horizontal" role="form" method="POST" action="{{url('/ruang/create')}}" enctype="multipart/form-data">
				{{ csrf_field() }}
				<div class="form-group{{ $errors->has('nama_ruang') ? ' has-error' : '' }}">
                            <label for="nama_ruang" class="col-md-4 control-label">Nama Ruangan</label>

                            <div class="col-md-6">
                                <input id="nama_ruang" type="text" class="form-control" name="nama_ruang" value="">
				...
				<div class="form-group{{ $errors->has('kode_ruang') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="kode_ruang" type="text" class="form-control" name="kode_ruang" value="">
